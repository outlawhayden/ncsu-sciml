...
# activation function name -> jax.nn handle
acts = {
...
for epoch in tqdm(range(num_epochs)):
    ...
    if test_loss < best_loss - 1e-8:
        ...
        patience_counter = 0
        # immediately save best model
        eqx.tree_serialise_leaves("dnn_model_opt.eqx", model)
    else:
        patience_counter += 1
...
print("best model saved to dnn_model_opt.eqx")
